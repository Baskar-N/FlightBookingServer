...
namespace BookingApiService.Migrations
{
    ...
    [Migration("20220626153737_Added-ReturnSheduleRecId")]
    partial class AddedReturnSheduleRecId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SharedModels.Models.Booking", b =>
                {
                    ...
                    b.Property<int?>("ReturnSheduleRecId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SharedModels.Models.Booking", b =>
                {
                    b.HasOne("SharedModels.Models.Discount", "Discount")
                        .WithMany()
                        .HasForeignKey("DiscountRecId");
